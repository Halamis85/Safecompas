...
// noinspection JSNonASCIINames
 ...
 function menuoopp() {
    ...
    async function fetchAndDisplayTodayHoliday() {
        ...
        holidayFoundSection.classList.add('d-none');
        noHolidaySection.classList.add('d-none');
        publicHolidayWarning.classList.add('d-none');
        displayDateFullElement.textContent = ''; // Vyčistíme datum
